...
if text == "ترند" and ChCheck(msg) then
if not msg.Addictive then
return merolua.sendText(msg_chat_id,msg_id,'\n*✧︙هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
GroupAllRtba = Redis:hgetall(hawks..':GroupUserCountMsg:'..msg.chat_id)
GetAllNames  = Redis:hgetall(hawks..':GroupNameUser:'..msg.chat_id)
GroupAllRtbaL = {}
...
return merolua.sendText(msg.chat_id,msg.id,Text,"md")
end
